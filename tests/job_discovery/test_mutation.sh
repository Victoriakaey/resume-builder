...
mutate_doc "skill: criterion 1 deleted"               '/sentences that could have been written by almost anyone/d'
mutate_doc "skill: criterion 2 deleted"               '/generic summaries or unnecessary conclusions/d'
mutate_doc "skill: criterion 3 deleted"               '/uncertainty was polished away/d'
mutate_doc "skill: criterion 4 deleted"               '/^4\. inflated language$/d'
mutate_doc "skill: criterion 5 deleted"                '/^5\. claims not present in my original notes$/d'
mutate_doc "skill: criterion 6 deleted"               '/overly symmetrical or formulaic structure/d'
mutate_doc "skill: criterion 7 deleted"               '/sound like LinkedIn\/AI writing/d'
mutate_doc "skill: 0/1/2 scale deleted"               '/0 not triggered, 1 slight, 2 clear/d'
mutate_doc "skill: 0-14 total / lower-is-human deleted" '/lower total means more human-sounding/d'
mutate_doc "skill: sub-scores rule deleted"           '/emits all seven sub-scores/d'
mutate_doc "skill: criterion 5 evidence sources deleted" '/is judged against `docs\/dossier\.md`/d'
